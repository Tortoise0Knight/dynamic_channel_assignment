...
blocking_rate_LODA_average_list_nonuniform_1 = [];
...
for traffic_load_index = 1:size(traffic_load_list, 3)
    ...
    blocking_rate_LODA_average_list_nonuniform_1 = [blocking_rate_LODA_average_list_nonuniform_1 blocking_rate_LODA_average];

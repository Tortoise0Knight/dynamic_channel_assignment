...
blocking_rate_BDCL_average_list_nonuniform_2 = [];
...
for traffic_load_index = 1:size(traffic_load_list, 3)
    ...
    blocking_rate_BDCL_average_list_nonuniform_2 = [blocking_rate_BDCL_average_list_nonuniform_2 blocking_rate_BDCL_average];
